    ...
    <section class="section dashboard">
        <div class="row">
            <div class="col-12 mb-3 text-center">
                <div class="dropdown">
                    <button class="btn btn-primary dropdown-toggle p-2 w-25" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Unidades</button>
